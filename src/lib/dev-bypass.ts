...
export const DEV_MOCK_PROFILES: Profile[] = [
  {
    ...
    school: 'CC', year: '2027', designation: 'student' as const, degree: 'BA', major: ['Computer Science', 'Philosophy'], clubs: ['Black Business Student Association'],
    pronouns: 'she/her',
    responses: [
  ...
  },
  {
    ...
    school: 'SEAS', year: '2026', designation: 'student' as const, degree: 'BS', major: ['Mechanical Engineering'], clubs: ['Columbia Basketball Club'],
    pronouns: 'he/him',
    responses: [
  ...
  },
  {
    ...
    school: 'GSAS', year: '2028', designation: 'student' as const, degree: 'PhD', major: ['Economics'], clubs: ['AI in Business Initiative', 'Asian Business Association'],
    pronouns: 'she/they',
    responses: [
  ...
  },
  {
    ...
    school: 'CC', year: '2028', designation: 'student' as const, degree: 'BA', major: ['History', 'Political Science'], clubs: [],
    pronouns: 'he/him',
    responses: [
  ...
  },
  {
    ...
    school: 'BC', year: '2026', designation: 'student' as const, degree: 'BA', major: ['Comparative Literature'], clubs: [],
    pronouns: 'she/her',
    responses: [
  ...
  },
  {
    ...
    school: 'SEAS', year: '2029', designation: 'student' as const, degree: 'BS', major: ['Computer Science'], clubs: [],
    pronouns: 'he/him',
    responses: [
  ...
  },
  {
    ...
    school: 'GS', year: '2027', designation: 'student' as const, degree: 'BA', major: ['Art History'], clubs: [],
    pronouns: 'she/her',
    responses: [
  ...
  },
  {
    ...
    school: 'CC', year: null, designation: 'faculty' as const, degree: null, major: ['Physics'], clubs: [],
    pronouns: 'he/him',
    responses: [
